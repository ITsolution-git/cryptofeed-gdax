...
var NodeBittrexApi = function (options) {
    'use strict';
    var request = require('request'), assign = require('object-assign'), hmac_sha512 = require('./hmac-sha512.js'), jsonic = require('jsonic'), signalR = require('signalr-client'), wsclient, cloudscraper = require('cloudscraper');
    ...
    var connectws = function (callback, force) {
        ...
        cloudscraper.get('https://bittrex.com/', function (error, response, body) {
            ...
            wsclient = new signalR.client(opts.websockets_baseurl, opts.websockets_hubs, undefined, true);
            if (opts.headers) {
...
//# sourceMappingURL=bittrex-wrapper.js.map