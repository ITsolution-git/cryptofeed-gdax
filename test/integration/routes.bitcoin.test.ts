...
describe('acceptance - loading express', function () {
  ...
  it('responds to bitcoin/single_card/request_payment', function (done) {

  	chai.request(app)
      .post('/api/v1/bitcoin/single_card/request_payment')
      .send({
			  "message": "message",
  ...
  it('responds to bitcoin/current_price', function (done) {

  	chai.request(app)
      .get('/api/v1/bitcoin/current_price')
      ...
      .end((err, res) => {
        ...
        should.exist(json)
        json.should.be.an('object')
        should.exist(json.btcAud)
        should.exist(json.btcUsd)

        done();
      })
  })

  it('responds to bitcoin/check_payment/1 should return true', function (done) {

  	chai.request(app)
      .get('/api/v1/bitcoin/check_payment/1')
  ...
  it('responds to bitcoin/single_card/request_payment should return error without params', function (done) {
